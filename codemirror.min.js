...
!(function (e, t) {
      ...
      for (var s = 0; s < l.length; ++s) {
        ...
        if (a.marker.collapsed) {
          var u = a.marker.find(0),
            c = tt(u.from, r) || Ot(a.marker) - Ot(i),
  ...
  function Zt(e, t) {
    var r = O("span", null, null, a ? "padding-right: .1px" : null),
      n = {
  ...
  function jr(e, t, r, n, i) {
    return n || (n = Xe(e.doc, t.line)), Vr(e, n, Ar(e, n, t.ch, i), r);
  }
  ...
  function Zi(e, t, r) {
    ...
    Qi(e, eo(e, t, n, !0)), (r && !1 === r.scroll) || !e.cm || An(e.cm);
  }
  function Qi(e, t) {
    t.equals(e.sel) ||
      ((e.sel = t),
                ...
                ? (function (e, t, r, n) {
                    ...
                    (tt(i.to(), t) > 0 || t.xRel < 0)
                      ...
                      : (function (e, t, r, n) {
                          ...
                          n.addNew && !n.extend
                            ? ((s = o.sel.contains(r)),
                              (l = s > -1 ? u[s] : new wi(r, r)))
                            : ((l = o.sel.primary()), (s = o.sel.primIndex));
                          if ("rectangle" == n.unit)
                            n.addNew || (l = new wi(r, r)),
                              (r = sn(e, t, !0, !0)),
                              (s = -1);
                          else {
                            var c = pl(e, r, n.unit);
                            ...
                            if (0 != tt(h, t))
                              if (((h = t), "rectangle" == n.unit)) {
                                for (
                                  var i = [],
                                    u = e.options.tabSize,
                                    c = R(Xe(o, r.line).text, r.ch, u),
                                    f = R(Xe(o, t.line).text, t.ch, u),
                                    d = Math.min(c, f),
                                    p = Math.max(c, f),
                                  ...
                                  d == p
                                    ...
                                    : m.length > y &&
                                      i.push(
                                        new wi(et(g, y), et(g, X(m, p, u)))
                                      );
                                }
                                i.length || i.push(new wi(r, r)),
                                  qi(
                                    o,
                                    xi(e, a.ranges.slice(0, s).concat(i), s),
                          ...
                          (e.state.selectingText = m),
                            ...
                            fe(i.wrapper.ownerDocument, "mouseup", m);
                        })(e, n, t, o);
                  })(t, n, o, e)
    ...
    (function (e) {
      ...
      fe(t.scroller, "touchstart", function (i) {
        ...
        (t.dragFunctions = {
          ...
          start: function (t) {
            return (function (e, t) {
              if (l && (!e.state.draggingText || +new Date() - Ao < 100)) Se(t);
              else if (
                !ve(e, t) &&
                !xr(e.display, t) &&
    ...
    function u(n) {
      ...
      if (
        ...
        if (
          ...
          (l = t.line + a) < e.first ||
          l >= e.first + e.size ||
          ((t = new et(l, t.ch, t.sticky)), !(s = Xe(e, l)))
        )
          return !1;
...
//# sourceMappingURL=/sm/c4056086762817e6f8ae28f868af141e37f039b83458a03f115b607be865ec11.map
